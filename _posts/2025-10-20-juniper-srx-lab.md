...
categories: ["Juniper"]
tags: [srx, lab,]
image: /images/juniper_virtlab/1.png
---
...
## Loop two physical ports on SRX  
...
## Configure Packet Mode and Disable Security Flow Juniper SRX 
...
## Create the 5-Router Topology with Virtual Router Instance type     
