...
categories: [VXLAN]
tags: [vxlan, linux, networking]
image: /images/static_vxlan/vxlan_tunnel2.jpg
---
...
## Run VMs and install bridge-utils
...
## Initial configuration of Linux srv and Nvidia Cumulus VX virtual switch
...
## Add static MAC record to forwarding database
