...
image: /images/aci_building_blocks/1.png
---
...
## Understanding the Tenant: The Administrative Boundary 
...
## VRF (Virtual Routing and Forwarding): The Layer 3 Isolation Domain  
...
## Bridge Domain (BD): The Layer 2 Forwarding Domain 
...
## Application Profile (AP): The Application Logical Container  
...
## EPG (Endpoint Group): The Granular Policy Enforcement Point  
...
## Endpoint Security Groups (ESGs): Decoupling Security from Forwarding  
