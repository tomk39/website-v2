...
categories: ["ACI"]
tags: [aci, fabric, leaf, spine]
image: /images/aci_access_polices/1.gif
---
...
## The End-to-End Workflow for Cisco ACI Access Policy Deployment
...
**<span style="font-size:18.0pt;" id="section2">1.1. Interface Policies Configuration Workflow.</span>**  
...
**<span style="font-size:18.0pt;" id="section3">1.2. Leaf Switches Policies Configuration Workflow.</span>**  
...
## Leaf Access Port configuration  
...
## Leaf Port Channel (PC) configuration  
...
## Leaf Virtual Port Channel (vPC) configuration  
